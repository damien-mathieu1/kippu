...
import { useKpisTimeSeries } from "@/api/tickets.api";
import { useMemo } from "react";

export function TicketTimeSeriesChart() {
    const { data: timeseries, isLoading, error } = useKpisTimeSeries();
    ...
    return (
        <Card className="w-full">
            <Card.Header>
                <Card.Title>Tickets Over Time (5-min intervals)</Card.Title>
            </Card.Header>
            <Card.Content>
                {isLoading ? (
